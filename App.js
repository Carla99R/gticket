...
global.domain = "https://appmovil.bancamiga.com:9011";
...
export default class App extends Component {
  ...
  async componentDidMount() {
    if (Application.applicationName != "Expo Go") {
      console.log = () => {
      }
      console.warn = () => {
      }
    ...
    return (
        ...
        <NavigationContainer ref={navigationRef}>
          <RootStack.Navigator initialRouteName={'Login'} screenOptions={{
            ...
            <RootStack.Screen name="Dashboard" component={Dashboard} options={options}/>
          </RootStack.Navigator>
        </NavigationContainer>
